...
- [x] 更新 readme 升级提示与优化内容简介，并单独生成升级提示文件 <!-- id: 122 -->
  - [x] 写入核心升级提示与优化说明至本地 升级提示 文件 <!-- id: 123 -->
  - [x] 修改 readme中文.md，加入 3.4+ 版本升级警告及近期底层重构优化简介 <!-- id: 124 -->
  - [x] 修改 readme.md，同步加入英文版本升级警告及近期底层重构优化简介 <!-- id: 125 -->
