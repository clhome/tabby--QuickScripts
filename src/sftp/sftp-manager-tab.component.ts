...
type DragPayload = {
  kind: 'local-file' | 'local-paths' | 'remote-file' | 'remote-dir' | 'remote-paths'
  fullPath?: string
  name?: string
  size?: number
  mode?: number
  remotePath?: string
  paths?: Array<{ fullPath?: string, remotePath?: string, name: string, isDirectory: boolean, size?: number, mode?: number }>
}
